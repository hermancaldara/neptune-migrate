...
class MainTest(BaseTest):
    ...
    def test_it_should_raise_error_if_config_is_not_an_instance_of_neptune_migrate_config(self):
        self.assertRaisesWithMessage(Exception,
    ...
    @patch('neptune_migrate.main.Virtuoso.get_current_version', return_value=(None, None))
...
#        execute_change_mock.assert_called_with('sparql_up', 'sparql_down', execution_log=_execution_log_mock)
    ...
    @patch('neptune_migrate.main.Main._execution_log')
    @patch('neptune_migrate.main.Virtuoso.execute_change')
    @patch('neptune_migrate.main.Virtuoso.get_current_version', return_value=('0.1', 'git'))
    @patch('neptune_migrate.main.Virtuoso._run_isql', return_value=("", ""))
...
#            call('_____________________________________________', 'YELLOW', log_level_limit=1),
    ...
    @patch('neptune_migrate.main.Main._get_destination_version', return_value='destination_version')
    @patch('neptune_migrate.main.Virtuoso', return_value=Mock(**{'get_current_version.return_value':('current_version', 'git'), 'get_sparql.return_value':('sparql_up', 'sparql_down')}))
    ...
    @patch('neptune_migrate.main.SimpleVirtuosoMigrate', return_value=Mock(**{'check_if_version_exists.return_value':True}))
    ...
    @patch('neptune_migrate.main.SimpleVirtuosoMigrate', return_value=Mock(**{'latest_version_available.return_value':'latest_version_available'}))
    ...
    @patch('neptune_migrate.main.SimpleVirtuosoMigrate', return_value=Mock(**{'check_if_version_exists.return_value':False}))
    @patch('neptune_migrate.main.Virtuoso', return_value=Mock(**{'get_current_version.return_value':('current_version', 'git')}))
    ...
    @patch('neptune_migrate.main.Main._execute_migrations')
    @patch('neptune_migrate.main.Virtuoso.get_current_version', return_value=('current_file', 'file'))
    @patch('neptune_migrate.main.Main._execution_log')
    @patch('neptune_migrate.main.CLI.msg')
    ...
    @patch('neptune_migrate.main.Main._execute_migrations')
    @patch('neptune_migrate.main.Virtuoso', return_value=Mock(**{'get_current_version.return_value':('current_version', 'git'), 'get_sparql.return_value':('sparql_up', 'sparql_down')}))
    @patch('neptune_migrate.main.SimpleVirtuosoMigrate.check_if_version_exists', return_value=True)
    @patch('neptune_migrate.main.Main._execution_log')
    @patch('neptune_migrate.main.CLI.msg')
    ...
    @patch('neptune_migrate.main.Main._execute_migrations')
    @patch('neptune_migrate.main.Virtuoso', return_value=Mock(**{'get_current_version.return_value':(None, None), 'get_sparql.return_value':('sparql_up', 'sparql_down')}))
    @patch('neptune_migrate.main.SimpleVirtuosoMigrate.check_if_version_exists', return_value=True)
    @patch('neptune_migrate.main.Main._execution_log')
    @patch('neptune_migrate.main.CLI.msg')
    ...
    @patch('neptune_migrate.main.Main._execute_migrations')
    @patch('neptune_migrate.main.Virtuoso', return_value=Mock(**{'get_current_version.return_value':('current_file', 'file'), 'get_sparql.return_value':('sparql_up', 'sparql_down')}))
    @patch('neptune_migrate.main.SimpleVirtuosoMigrate.check_if_version_exists', return_value=True)
    @patch('neptune_migrate.main.Main._execution_log')
    @patch('neptune_migrate.main.CLI.msg')
